...
- [ ] 3. PathWorkspaceTrait と WorkspaceEnum の実装
- [ ] 3.1 PathWorkspaceTrait トレイトの定義
...
- [ ] 3.2 既存 PathWorkspace への PathWorkspaceTrait 実装
...
- [ ] 3.3 WorkspaceEnum による静的ディスパッチの実装
...
- [ ] 4. TimeStepFirstWorkspace の実装
- [ ] 4.1 TimeStepFirstWorkspace 構造体の実装
...
- [ ] 4.2 TimeStepFirstWorkspace のトレイト実装
