...
- [x] 1. Cargo.toml と lib.rs の基盤構築
- [x] 1.1 service_gateway の Cargo.toml に feature flag・依存・ターゲットを追加する
...
- [x] 1.2 lib.rs を新規作成し、既存モジュールの公開宣言と feature-gated モジュール宣言を行う
...
- [x] 1.3 main.rs を lib.rs 経由のモジュール参照に変更する
...
- [x] 2. (P) ServerError にCLI 固有のエラーバリアントを追加する
...
- [x] 3. (P) Python バインディングの移植
- [x] 3.1 (P) python モジュールの骨格を作成し、register_module 関数を定義する
...
- [x] 3.2 (P) service_python のバインディング実装を移植する
...
- [x] 4. CLI モジュールの移植
- [x] 4.1 cli モジュールの骨格を作成し、Clap CLI 構造体を定義する
