...
- [ ] 2.5 lib.rs に app_config モジュールを追加
  - `mod app_config` を追加
  - `AppConfig` を prelude にエクスポート
  - _Requirements: 4.1_

- [ ] 3. /api/config エンドポイントの実装
- [ ] 3.1 config handler を実装
