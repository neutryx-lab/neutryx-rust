...
- [x] 1. 基盤コンポーネント（エラー型・設定）
- [x] 1.1 (P) ブートストラップ専用エラー型の実装
...
- [x] 2. 市場商品入力
- [x] 2.1 BootstrapInstrument enumの実装
