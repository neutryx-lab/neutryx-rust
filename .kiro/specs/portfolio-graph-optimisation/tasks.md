...
- [ ] 2. PortfolioGraphExtractorの実装
- [ ] 2.1 PortfolioGraphExtractableトレイトを定義
...
- [ ] 3. SamplePortfolioBuilderの実装
- [ ] 3.1 SamplePortfolioBuilder構造体を定義
...
- [ ] 4. Web Dashboard REST APIの実装
- [ ] 4.1 `/api/v1/portfolio/graph`エンドポイント実装
...
- [ ] 4.3 `/api/v1/portfolio/trades`エンドポイント実装
...
- [ ] 7. テスト実装
- [ ] 7.1 GraphNode拡張のユニットテスト
  - `trade_ids`フィールドのserde動作テスト（空時省略、非空時出力）
  - `Default`トレイト動作確認
  - 既存テストとの後方互換性確認
  - _Requirements: 1.4_

- [ ] 7.2 (P) PortfolioGraphExtractorのユニットテスト
...
- [ ] 7.3 (P) SamplePortfolioBuilderのユニットテスト
