...
- [x] 1.2 dependency-management.md ステアリングを更新
...
- [x] 2. Book 構造体に bon Builder を適用
- [x] 2.1 (P) Book 構造体を bon Builder に移行
...
- [x] 4. CounterParty 構造体に bon Builder を適用
- [x] 4.1 CounterParty 構造体を bon Builder に移行
...
- [x] 4.2 CounterParty Builder の動作確認テスト
  - CounterParty Builder の基本動作を確認
  - 既存の CounterParty 関連テストが全てパスすることを確認
  - _Requirements: 4.1, 4.3_

- [x] 5. CsaTerms 構造体に bon Builder を適用
- [x] 5.1 CsaTerms 構造体を bon Builder に移行
...
- [x] 5.2 CsaTerms Builder の動作確認テスト
...
- [x] 6. Trade 構造体に bon Builder を適用
- [x] 6.1 Trade 構造体を bon Builder に移行
...
- [x] 7. LegConfig 構造体の新規作成
- [x] 7.1 LegConfig 構造体を設計・実装
...
- [x] 7.2 LegConfig の変換メソッドを実装
  - into_fixed_leg(rate: f64) -> Leg メソッドを実装
  - into_floating_leg(index: RateIndex, spread: f64) -> Leg メソッドを実装
  - validate() は明示的に呼び出すパターンを採用
  - 既存の LegBuilder::build_fixed/build_floating と同等の Leg 生成ロジックを実装
  - _Requirements: 2.2, 2.4_

- [x] 7.3 LegConfig の単体テスト作成
...
- [x] 8.2 他クレートの LegBuilder 呼び出しを更新
  - ワークスペース全体のビルドが成功することを確認
  - deprecated 警告を許可するアノテーションを追加
