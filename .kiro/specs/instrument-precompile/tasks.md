...
- [ ] 3. InstrumentCompiler の実装
- [ ] 3.1 コンパイラスキャフォールドと検証ロジック
...
- [ ] 4. CalibrationProblem 統合
- [ ] 4.1 コンパイル済み商品からの構築メソッド
...
- [ ] 4.2 CurveDefinition からの構築メソッド
  - from_curve_definition() メソッドを実装
...
- [ ] 4.3 後方互換性の検証
  ...
  - 既存のキャリブレーションテストが全てパスすることを確認
  - 依存: 4.1, 4.2 完了後に実行
  - _Requirements: 6.1, 6.2, 6.3, 6.4, 6.5_

- [ ] 5. InterpolationMatrix の拡張
- [ ] 5.1 (P) ベクトル積による一括 DF 計算メソッド
...
- [ ] 6.2 パフォーマンス目標の検証
  - イテレーションあたり 30% 以上の速度向上を達成することを確認
  - コンパイルコストがキャリブレーション全体の 5% 未満であることを測定
  - メモリ使用量の増加が 20% 未満であることを検証
  - ベンチマーク結果をドキュメント化
  - 依存: 6.1 完了後に実行
