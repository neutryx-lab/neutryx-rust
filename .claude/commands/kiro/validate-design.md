...
1. **Load Context**:
   ...
   - Read `.claude/specs/$1/requirements.md` for requirements
   - Read `.claude/specs/$1/design.md` for design document
...
2. **Read Review Guidelines**:
   - Read `.claude/settings/kiro/rules/design-review.md` for review criteria and process
