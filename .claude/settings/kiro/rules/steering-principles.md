...
- Detailed documentation of `.claude/` metadata directories (settings, automation)
...
- Light references to `.claude/specs/` and `.claude/steering/` are acceptable; avoid other `.claude/` internal directories
