...
//! - **IRS AAD Demo**: IRS pricing with AAD vs Bump-and-Revalue performance comparison
//!
...
//! - Pricer layer is accessed including pricer_pricing for IRS AAD Demo (with l1l2-integration)
