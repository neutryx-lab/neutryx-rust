  ...
  <div class="xva-view">
    ...
    <div class="glass-card p-6 mb-6">
      ...
      <Transition name="accordion">
        <div v-show="configExpanded" class="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
          <div>
          ...
          <div class="flex items-center gap-2">
            <input v-model="antithetic" type="checkbox" id="antithetic" class="rounded">
            <label for="antithetic" class="text-sm text-[var(--text-secondary)]">Antithetic Variates</label>
          </div>
          <div class="flex items-center gap-2">
            <input v-model="bilateral" type="checkbox" id="bilateral" class="rounded">
            <label for="bilateral" class="text-sm text-[var(--text-secondary)]">Bilateral CVA/DVA</label>
          </div>
          <div class="flex items-center gap-2">
            <input v-model="computeFva" type="checkbox" id="computeFva" class="rounded">
            <label for="computeFva" class="text-sm text-[var(--text-secondary)]">Compute FVA</label>
          </div>
        </div>
      </Transition>
    </div>
    ...
    <div v-if="result" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div
    ...
    <div v-if="!result && !loading" class="glass-card p-12 text-center">
      ...
      <p class="text-sm text-[var(--text-muted)] mb-4">Configure parameters above and click "Run Simulation" to compute XVA.</p>
