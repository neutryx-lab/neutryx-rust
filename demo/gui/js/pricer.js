...
const genericPricer = {
    ...
    async price() {
        ...
        try {
            ...
            this.showPricingError(error.message);
        }
    },
        ...
        if (this.elements.pvResult) {
            this.elements.pvResult.innerHTML = `
                <div class="pricer-error-card">
                    ...
                    <div class="error-message">Pricing failed: ${message}</div>
                </div>
            `;
        }
    },
    ...
    async calculateGreeks() {
        ...
        try {
            ...
            this.showGreeksError(error.message);
        }
    },
    ...
    showGreeksError(message) {
        ...
        if (container) {
            container.innerHTML = `
                <div class="pricer-error-card">
                    <div class="error-icon"><i class="fas fa-exclamation-triangle"></i></div>
                    <div class="error-message">Greeks calculation failed: ${message}</div>
                </div>
            `;
        }
    },
