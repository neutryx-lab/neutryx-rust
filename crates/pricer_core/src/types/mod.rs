...
//! - `BusinessDayConvention` - Use `infra_master::BusinessDayConvention` directly
...
#[deprecated(since = "0.2.0", note = "Use infra_master::DayCountConvention directly")]
pub use infra_master::DayCountConvention;
#[deprecated(since = "0.2.0", note = "Use infra_master::BusinessDayConvention directly")]
