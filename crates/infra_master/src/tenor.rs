//! Financial tenor (period) definitions.
//!
//! This module provides type-safe representations of financial tenors
//! such as 3M, 6M, 1Y, etc.
//!
//! # Examples
//!
//! ```
//! use infra_master::{Date, Tenor, EndOfMonthRule};
//!
//! let date = Date::from_ymd(2024, 1, 15).unwrap();
//! let tenor = Tenor::ThreeMonths;
//!
//! let future_date = tenor.add_to_date(date, EndOfMonthRule::Adjust);
//! assert_eq!(future_date, Date::from_ymd(2024, 4, 15).unwrap());
//! ```
...
pub enum EndOfMonthRule {
    ...
    /// Same behavior as Preserve for most cases.
    None,
}
