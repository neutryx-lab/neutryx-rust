...
///
/// ```
/// use pricer_models::market::curves::{CreditCurve, HazardRateCurve};
///
...
impl<T: Float> HazardRateCurve<T> {
    ...
    ///
    /// ```
    /// use pricer_models::market::curves::HazardRateCurve;
    ///
...
///
/// ```
/// use pricer_models::market::curves::{CreditCurve, FlatHazardRateCurve};
///
