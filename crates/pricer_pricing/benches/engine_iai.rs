...
//! cargo bench --bench engine_iai
//!
//! # Compare with baseline
//! cargo bench --bench engine_iai -- --save-baseline=main
//! cargo bench --bench engine_iai -- --baseline=main
//! ```
//!
//! # Benchmark Coverage
//!
//! - GBM path generation (core MC engine)
