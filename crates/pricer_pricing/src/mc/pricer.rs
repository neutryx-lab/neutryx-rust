...
impl MonteCarloPricer {
    ...
    ///
    /// This allows external code to capture the current seed and use `reset_with_seed`
    /// to ensure consistent random numbers across multiple pricings (e.g., for Greeks).
    #[inline]
