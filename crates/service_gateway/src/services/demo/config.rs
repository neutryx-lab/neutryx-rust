        ...
        let instruments = vec![
            ...
            def(
                ...
                vec![
                    currency_pair_param(),
                    ParameterDef {
                        name: "notionalPerFixing".into(),
                        label: Some("Notional per Fixing".into()),
                        field_type: FieldType::Number,
                    ...
                    strike_param(),
                    ParameterDef {
                        name: "targetProfit".into(),
                        label: Some("Target Profit".into()),
                        field_type: FieldType::Number,
                    ...
                    ParameterDef {
                        name: "maturity".into(),
                        label: Some("Maturity (years)".into()),
                        field_type: FieldType::Number,
                    ...
                    ParameterDef {
                        name: "domesticRate".into(),
                        label: Some("Domestic Rate".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(0.05)),
                        options: None,
                        validation: None,
                    ...
                    ParameterDef {
                        name: "foreignRate".into(),
                        label: Some("Foreign Rate".into()),
                        field_type: FieldType::Number,
                ...
                vec![ParameterDef {
                    name: "numFixings".into(),
                    label: Some("Number of Fixings".into()),
                    field_type: FieldType::Number,
                ...
                vec![
                    ParameterDef {
                        ...
                        options: Some(vec![
                            ...
                            ParameterOption {
                                value: "SX5E".into(),
                                label: "Euro Stoxx 50".into(),
                            },
                            ParameterOption {
                                value: "NKY".into(),
                                label: "Nikkei 225".into(),
                            },
                        ]),
                        validation: None,
                    },
                    ...
                    ParameterDef {
                        name: "autocallBarrier".into(),
                        label: Some("Autocall Barrier".into()),
                        field_type: FieldType::Number,
                    ...
                    ParameterDef {
                        name: "couponRate".into(),
                        label: Some("Coupon Rate".into()),
                        field_type: FieldType::Number,
                    ...
                    ParameterDef {
                        name: "rate".into(),
                        label: Some("Risk-Free Rate".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(0.05)),
                        options: None,
                        validation: None,
            ...
            def(
                ...
                vec![
                    ParameterDef {
                        name: "meanReversion".into(),
                        label: Some("Mean Reversion".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(0.03)),
                        options: None,
                        validation: None,
                    ...
                    ParameterDef {
                        name: "fundingRate".into(),
                        label: Some("Funding Rate".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(0.03)),
                        options: None,
                        validation: None,
                    ...
                    ParameterDef {
                        ...
                        label: Some("Coupon Rate".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(0.035)),
                        options: None,
                        validation: None,
                    },
                    ParameterDef {
                        name: "normalVolBp".into(),
                        label: Some("Normal Vol (bp)".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(80.0)),
                        options: None,
                        validation: None,
                    },
                    ParameterDef {
                        name: "numExercises".into(),
                        label: Some("Exercise Dates".into()),
                        field_type: FieldType::Number,
                    ...
                    ParameterDef {
                        name: "swapTenor".into(),
                        label: Some("Swap Tenor (years)".into()),
                        field_type: FieldType::Number,
                ...
                vec![
                    ParameterDef {
                        name: "numGridPoints".into(),
                        label: Some("Grid Points".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(41)),
                        options: None,
                        validation: None,
                    },
                    ParameterDef {
                        name: "numStdDevs".into(),
                        label: Some("Std Devs".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(5.0)),
                        options: None,
                        validation: None,
                    ...
                    ParameterDef {
                        name: "isCallable".into(),
                        label: Some("Callable".into()),
                        field_type: FieldType::Select,
                        default_value: Some(serde_json::json!("true")),
                        options: Some(vec![
                            ParameterOption {
                    ...
                    ParameterDef {
                        name: "flatCoupon".into(),
                        label: Some("Flat Coupon".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(0.01)),
                        options: None,
                        validation: None,
            ...
            def(
                ...
                vec![
                    ...
                    ParameterDef {
                        name: "tarnAmount".into(),
                        label: Some("TARN Amount".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(0.10)),
                        options: None,
                        validation: None,
                ...
                vec![
                    ...
                    ParameterDef {
                        name: "numCouponGridPoints".into(),
                        label: Some("Coupon Grid".into()),
                        field_type: FieldType::Number,
                        default_value: Some(serde_json::json!(10)),
                        options: None,
                        validation: None,
                    ...
                    ParameterDef {
                        name: "excessCouponFlag".into(),
                        label: Some("Excess Coupon".into()),
                        field_type: FieldType::Select,
                    ...
                    ParameterDef {
                        name: "hasBermudanExercise".into(),
                        label: Some("Bermudan Exercise".into()),
                        field_type: FieldType::Select,
                        default_value: Some(serde_json::json!("false")),
                        options: Some(vec![
                            ParameterOption {
